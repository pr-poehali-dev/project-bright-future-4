...
const faqs = [
  {
    question: "Сколько стоит каркасный дом?",
    answer:
      "Стоимость зависит от площади, проекта и комплектации. Небольшой дачный дом 60 м² обходится от 1,5 млн рублей, коттедж 120–150 м² — от 3 млн. Мы всегда фиксируем цену в договоре — без неожиданных доплат.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "При качественном строительстве и правильной эксплуатации — 50–100 лет. Деревянный каркас обрабатывается антисептиком, все узлы продуманы для долговечности. Мы даём гарантию на конструктив 5 лет.",
  },
  {
