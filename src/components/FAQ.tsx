...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Да, небольшие изменения возможны на этапе согласования проекта и в начале строительства. Чем раньше вы сообщите о пожеланиях — тем проще и дешевле их реализовать. Серьёзные изменения на поздних этапах могут повлиять на сроки и стоимость, поэтому мы уделяем особое внимание детальному обсуждению проекта до начала работ.",
  },
]
