...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Дом площадью до 150 м² возводится за 1–2 месяца при хорошей погоде. Это в 2–3 раза быстрее, чем кирпич или газобетон. После подписания договора мы согласовываем чёткий график и строго его соблюдаем.",
  },
  {
