...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Дом площадью до 150 м² возводится за 1–3 месяца при хорошей погоде. Это в 2–3 раза быстрее, чем кирпич или газобетон. После подписания договора мы согласовываем чёткий график и строго его соблюдаем.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Мы работаем только с проверенными поставщиками и используем сертифицированные материалы. Каркас — сухая строганая доска, утеплитель — базальтовая вата или эковата, паро- и ветрозащитные мембраны ведущих производителей. На каждый материал имеются сертификаты качества, которые мы предоставляем по запросу.",
  },
]
    ...
    <section id="faq" className="py-20 md:py-29">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-2xl sm:text-4xl font-medium leading-[1.15] tracking-tight mb-6 text-balance lg:text-5xl">
            Частые вопросы
          </h2>
        </div>
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-border">
              <button
                ...
                className="w-full py-4 sm:py-6 flex items-start justify-between gap-4 sm:gap-6 text-left group"
              >
                <span className="text-base sm:text-lg font-medium text-foreground transition-colors group-hover:text-foreground/70">
                  {faq.question}
                </span>
                <Plus
