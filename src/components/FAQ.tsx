...
const faqs = [
  ...
  {
    question: "Даёте ли вы гарантию на строительство?",
    answer:
      "Да, мы предоставляем официальную гарантию на все выполненные работы. На несущие конструкции — 5 лет, на отделочные работы — 2 года. Все условия прописываются в договоре. После сдачи объекта мы остаёмся на связи и оперативно устраняем любые вопросы по гарантии.",
  },
]
