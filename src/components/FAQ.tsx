...
const faqs = [
  {
    ...
    answer:
      "Выбор фундамента зависит от типа грунта, нагрузки дома и бюджета. Для каркасных домов чаще всего используют свайно-винтовой — быстрый и доступный вариант, или ленточный — для более тяжёлых и долговечных конструкций. Мы проводим анализ участка и рекомендуем оптимальное решение под ваш проект.",
  },
  {
