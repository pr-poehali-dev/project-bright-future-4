...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Мы работаем только с проверенными поставщиками и используем сертифицированные материалы. Каркас — сухая строганая доска, утеплитель — минеральная вата Knauf, паро- и ветрозащитные мембраны ведущих производителей. На каждый материал имеются сертификаты качества, которые мы предоставляем по запросу.",
  },
]
