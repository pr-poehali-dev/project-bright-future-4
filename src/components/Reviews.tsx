...
const reviews = [
  ...
  },
  {
    name: "Павел Кузнецов",
    location: "Тульская область",
    text: "Строили баню на дачном участке. Ребята приехали вовремя, работали без задержек. Особо порадовало — сами вывезли весь строительный мусор. Баня получилась тёплой и красивой, соседи уже спрашивают контакты.",
    rating: 5,
    date: "Июль 2024",
  },
  {
