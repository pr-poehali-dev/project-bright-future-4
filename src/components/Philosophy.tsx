...
const philosophyItems = [
  {
    ...
    description:
      "Каркасная технология позволяет возвести дом за 1–3 месяца. Мы не жертвуем ни одним этапом — от фундамента до финишной отделки.",
    icon: "Zap",
  },
  {
  ...
  },
  {
    ...
    description:
      "Используем только проверенные материалы от надёжных поставщиков. Сухая строганая доска, современные утеплители и влагостойкие плиты — всё для долговечности вашего дома.",
    icon: "Package",
  },
  {
