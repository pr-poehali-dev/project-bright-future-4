    ...
    <>
      <div className={`fixed bottom-6 left-4 z-50 flex flex-col gap-2 transition-all duration-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"}`}>
        <button
          onClick={scrollToTop}
          aria-label="Наверх"
          className="w-11 h-11 flex items-center justify-center text-orange-500 active:scale-95 transition-transform"
        >
      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex items-end justify-center p-4 md:hidden">
          ...
          <div className="relative w-full max-w-md p-8 shadow-2xl mb-2" style={{backgroundColor: '#2b2b2b'}}>
            <button
            ...
            <h2 className="text-2xl font-bold mb-4" style={{color: '#E9A662'}}>Наши контакты</h2>
            <div className="flex items-center gap-2 mb-6 text-sm" style={{color: 'rgba(233, 166, 98, 0.6)'}}>
