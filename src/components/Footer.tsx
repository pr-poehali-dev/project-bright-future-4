        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-16">
          ...
          <div className="col-span-2 md:col-span-2">
            <a href="/" className="inline-flex items-center gap-3 mb-6">
              <img src="https://cdn.poehali.dev/files/81218afd-c0f8-4ab8-8954-5409def67550.jpg" alt="TS logo" loading="lazy" decoding="async" className="w-9 h-9 rounded flex-shrink-0 object-cover" />
