...
const images = [
  {
    src: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/bucket/e39f10f3-04a3-460e-88d9-b97ad3df9611.png",
    alt: "Баня «Парная 25» — вид снаружи с террасой",
  },
  {
    src: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/bucket/bab266f6-de7e-4a73-9a63-8e79893bc4b8.jpg",
    alt: "Баня «Парная 25» — интерьер парилки",
  },
]

const specs = [
  { label: "Габариты", value: "5,0 × 5,0 м" },
  { label: "Общая площадь", value: "25 м²" },
  { label: "Этажей", value: "1" },
  { label: "Парилка", value: "есть" },
  { label: "Терраса", value: "есть" },
  { label: "Фундамент", value: "Сваи" },
  { label: "Фасад", value: "Натуральное дерево" },
  { label: "Год постройки", value: "2026" },
]

export default function Banya25Hero() {
    ...
    <>
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="container mx-auto px-6 md:px-12 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span>/</span>
          <span className="text-[#1a0f0f] font-medium">Баня «Парная 25»</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight mb-4 leading-tight">
                Баня «Парная 25»<br />
                <span className="text-orange-500">5,0 × 5,0 м</span>
              </h1>
              <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6">
                Компактная каркасная баня <strong>25 м²</strong> на свайном фундаменте — натуральный деревянный
                фасад, тёплая парилка с печью и уютная терраса. Баня быстро прогревается и отлично держит жар.
                Терраса — идеальное место, чтобы отдышаться после парилки. Строим под ключ по всей Тульской области.
              </p>
