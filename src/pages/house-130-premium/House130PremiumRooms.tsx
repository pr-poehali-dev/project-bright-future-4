const rooms = [
  {
    ...
    area: "50,5 м²",
    img: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/files/12b93839-f3df-40c8-8dae-de71b45df831.jpg",
    description: "Просторное пространство со вторым светом и панорамными окнами на террасу. Современная кухня с островом, обеденная зона и мягкая гостиная с угловым диваном.",
  },
  {
    name: "Мастер-спальня",
    area: "10,9 м²",
  ...
  },
  {
    name: "Терраса",
    area: "16,2 м²",
    img: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/files/554fe155-a849-4582-b3d3-daf8e2452000.jpg",
  ...
  },
  {
    ...
    area: "13×10 м",
    img: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/files/da5b371a-4e15-4946-ab38-c91830122179.jpg",
    description: "Высокие панорамные окна с антрацитовым профилем перед террасой. Имитация бруса, серая металлочерепица, винтовые сваи.",
  },
]
