...
export default function House130PremiumOrderForm() {
    ...
    try {
      await fetch("https://functions.poehali.dev/47abad41-4ccf-413e-9fab-2c7da189c73c", {
        ...
        body: JSON.stringify({
          name,
          phone,
          comment: "Заявка со страницы: Дом «Премиум» 130 м² 13×10 + терраса 20 м²",
          buildingType: "Дом",
          area: 130,
        }),
      })
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="bg-white p-8 shadow-sm">
                ...
                <div className="bg-orange-50 border border-orange-100 rounded px-4 py-3 mb-6 text-sm text-orange-700">
                  <strong>Проект:</strong> Дом «Премиум» 130 м² · 13,0 × 10,0 м · Сваи · Терраса 20 м² · Сауна
                </div>
                <button
                  type="submit"
