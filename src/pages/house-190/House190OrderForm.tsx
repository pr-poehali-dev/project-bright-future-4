...
export default function House190OrderForm() {
    ...
    try {
      await fetch("https://functions.poehali.dev/47abad41-4ccf-413e-9fab-2c7da189c73c", {
        ...
        body: JSON.stringify({
          name,
          phone,
          comment: "Заявка со страницы: Каркасный дом «Берёзка» 190 м²",
          buildingType: "Дом",
          area: 190,
        }),
      })
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="bg-white p-8 shadow-sm">
                ...
                <div className="bg-orange-50 border border-orange-100 rounded px-4 py-3 mb-6 text-sm text-orange-700">
                  <strong>Проект:</strong> Дом «Берёзка» 190 м² · 10,0 × 8,0 м · 2 этажа · 5 спален · Сваи
                </div>
                <button
                  type="submit"
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-sm text-gray-400 text-center">
              Строим каркасные дома и бани по Тульской области · Тепло · Надёжно · С гарантией
            </p>
