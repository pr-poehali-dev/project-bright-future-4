...
const images = [
  {
    ...
    alt: "Каркасный дом 193 м² — вид спереди с террасой и балконом",
  },
  {
    src: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/bucket/45fc0cb8-7c4f-4522-b9ed-ca713f349c20.jpg",
    alt: "Каркасный дом 193 м² — вид сзади",
  },
  {
    src: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/bucket/eefcab28-e932-4c98-9188-ad6f0b6fb60b.jpg",
    alt: "Каркасный дом 193 м² — план первого этажа",
  },
  {
    src: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/bucket/f874f6dc-3b54-4389-8776-a5800a7a4d97.jpg",
    alt: "Каркасный дом 193 м² — план второго этажа",
  },
  {
    src: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/bucket/0d0536dc-95d0-4855-9501-31f2c95d6d82.jpg",
    alt: "Каркасный дом 193 м² — вид сбоку",
  },
]

const specs = [
  { label: "Габариты", value: "10,7 × 10,2 м" },
  { label: "Общая площадь", value: "193 м²" },
  { label: "Этажей", value: "2" },
  { label: "Спален", value: "4" },
  { label: "Терраса", value: "32,08 м²" },
  { label: "Балкон", value: "6,13 м²" },
  { label: "Сауна", value: "есть" },
  { label: "Второй свет", value: "есть" },
]

export default function House193Hero() {
    ...
    <>
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="container mx-auto px-6 md:px-12 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span>/</span>
          <span className="text-[#1a0f0f] font-medium">Усадьба «Тёмный бор» 193 м²</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight mb-4 leading-tight">
                Усадьба «Тёмный бор»<br />
                <span className="text-orange-500">10,7 × 10,2 м</span>
              </h1>
              <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6">
                Просторный двухэтажный каркасный дом <strong>193 м²</strong> с тёмным планкеном и
                натуральными деревянными акцентами. Вторым светом в гостиной, четырьмя спальнями,
                собственной сауной, огромной террасой и балконом — всё для полноценной семейной жизни
                за городом. Строим под ключ по всей Тульской области.
              </p>
