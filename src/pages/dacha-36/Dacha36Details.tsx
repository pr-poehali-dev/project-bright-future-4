...
const whyList = [
  ...
  "Имитация бруса с деревянными акцентами — уютный загородный вид",
  "Мягкая кровля — надёжная защита от снега и дождя",
...
const included = [
  ...
  "Мягкая кровля",
  "Фасадная отделка — имитация бруса + деревянные акценты",
