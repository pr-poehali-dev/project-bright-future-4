...
export default function Dacha36OrderForm() {
    ...
    try {
      await fetch("https://functions.poehali.dev/47abad41-4ccf-413e-9fab-2c7da189c73c", {
        ...
        body: JSON.stringify({
          name,
          phone,
          comment: "Заявка со страницы: Каркасная дача «Берёзка» 36 м²",
          buildingType: "Дача",
          area: 36,
        }),
      })
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="bg-white p-8 shadow-sm">
                ...
                <div className="bg-orange-50 border border-orange-100 rounded px-4 py-3 mb-6 text-sm text-orange-700">
                  <strong>Проект:</strong> Дача «Берёзка» 36 м² · 6,03 × 6 м · 1 спальня · Сваи
                </div>
                <button
                  type="submit"
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-sm text-gray-400 text-center">
              Строим каркасные дома и дачи по Тульской области · Тепло · Надёжно · С гарантией
            </p>
