...
const images = [
  {
    ...
    alt: "Каркасная баня «Горизонт 68» — вид спереди с террасой",
  },
  {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div>
              ...
              <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6">
                Каркасная баня площадью <strong>68 м²</strong> с тёплым деревянным фасадом из
                планкена и панорамным остеклением. Просторная комната отдыха, встроенная парная, две террасы общей
                площадью почти 20 м² — всё, что нужно для комфортного банного отдыха на природе.
