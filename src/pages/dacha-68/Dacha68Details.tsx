...
const whyList = [
  "Каркасная технология — баня готова за 20–30 дней при хороших погодных условиях",
  "Тёплые стены 100–200 мм минваты, минимальный расход тепла",
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100">
            {[
              ...
              { value: "20–30 дней", label: "Срок постройки", sub: "Каркасная технология позволяет заселиться уже этим сезоном", orange: true },
            ].map((s) => (
