...
export default function House88OrderForm() {
    ...
    try {
      await fetch("https://functions.poehali.dev/47abad41-4ccf-413e-9fab-2c7da189c73c", {
        ...
        body: JSON.stringify({
          name,
          phone,
          comment: "Заявка со страницы: Каркасный дом «Графит» 88 м²",
          buildingType: "Дом",
          area: 88,
        }),
      })
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="bg-white p-8 shadow-sm">
                ...
                <div className="bg-orange-50 border border-orange-100 rounded px-4 py-3 mb-6 text-sm text-orange-700">
                  <strong>Проект:</strong> Дом «Графит» 88 м² · 10,0 × 9,0 м · 1 этаж · 2 спальни · Сваи
                </div>
                <button
                  type="submit"
