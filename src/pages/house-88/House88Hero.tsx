...
const images = [
  {
    ...
    alt: "Дом «Графит» 88 м² — вид спереди с верандой",
  },
  {
    src: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/bucket/c61506d1-af54-4cc2-b2ea-b9f041a7d6bb.jpg",
    alt: "Дом «Графит» 88 м² — боковой фасад",
  },
  {
    src: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/bucket/810e5911-e6b0-4191-9b83-8a22384edc09.jpg",
    alt: "Дом «Графит» 88 м² — фасадный чертёж",
  },
  {
    src: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/bucket/4d2ebc35-b514-4a30-a6df-fbdd64e0c10b.jpg",
    alt: "Дом «Графит» 88 м² — план этажа",
  },
]

const specs = [
  { label: "Общая площадь", value: "88 м²" },
  { label: "Габариты", value: "10,0 × 9,0 м" },
  { label: "Этажей", value: "1" },
  { label: "Спальни", value: "2" },
  { label: "Санузлы", value: "1" },
  { label: "Фундамент", value: "Сваи" },
  { label: "Терраса", value: "11,48 м²" },
  { label: "Гостиная", value: "20,16 м²" },
]

export default function House88Hero() {
    ...
    <>
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="container mx-auto px-6 md:px-12 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span>/</span>
          <span className="text-[#1a0f0f] font-medium">Дом «Графит» 88 м²</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight mb-4 leading-tight">
                Дом «Графит»<br />
                <span className="text-orange-500">10,0 × 9,0 м</span>
              </h1>
              <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6">
                Одноэтажный каркасный дом <strong>88 м²</strong> в современном стиле — тёмный графитовый фасад
                из планкена с тёплыми деревянными акцентами и чёрной металлочерепицей. Строгий и стильный снаружи,
                уютный внутри: просторная <strong>гостиная 20,16 м²</strong>, две спальни, кухня и терраса.
                На свайном фундаменте — подходит для любого участка.
