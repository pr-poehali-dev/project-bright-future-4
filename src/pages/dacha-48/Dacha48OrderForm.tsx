...
export default function Dacha48OrderForm() {
    ...
    try {
      await fetch("https://functions.poehali.dev/47abad41-4ccf-413e-9fab-2c7da189c73c", {
        ...
        body: JSON.stringify({
          name,
          phone,
          comment: "Заявка со страницы: Дача «Уютная» 48 м² 6×8",
          buildingType: "Дача",
          area: 48,
        }),
      })
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="bg-white p-8 shadow-sm">
                ...
                <div className="bg-orange-50 border border-orange-100 rounded px-4 py-3 mb-6 text-sm text-orange-700">
                  <strong>Проект:</strong> Дача «Уютная» 48 м² · 6,0 × 8,0 м · Сваи · Открытая терраса
                </div>
                <button
                  type="submit"
