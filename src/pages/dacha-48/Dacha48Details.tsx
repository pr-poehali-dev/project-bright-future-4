...
const whyList = [
  ...
  "Имитация бруса — натуральный тёплый вид без лишнего ухода",
  "Металлочерепица — надёжная кровля без протечек на годы вперёд",
  "Просторные 48 м² — всё необходимое на одном этаже",
  "Открытая терраса с деревянным настилом — уличная гостиная",
  "Светлый интерьер с деревянной вагонкой — тепло и уют",
...
const included = [
  ...
  "Фасадная отделка — имитация бруса",
...
export default function Dacha48Details() {
  return (
    <>
      ...
      <section className="py-16 md:py-24 bg-[#1a0f0f] text-white">
        <div className="container mx-auto px-6 md:px-12 text-center">
          ...
          <blockquote className="max-w-2xl mx-auto text-xl md:text-2xl font-medium leading-relaxed mb-6">
            «Наш домик 6×8 с уютной террасой готов. Качество — пушка, сроки — рекордные, а эмоции просто зашкаливают! Спасибо за профессионализм и наш новый уголок счастья. Всем рекомендую!»
          </blockquote>
          <p className="text-gray-400 text-sm">— Алина Миронова, Тульская область, 2026</p>
        </div>
      </section>
    </>
  )
