...
const whyList = [
  "Каркасная технология — дача готова за 60–90 дней",
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100">
            {[
              ...
              { value: "90 дней", label: "Срок постройки", sub: "Каркасная технология позволяет заехать в дачу уже в этом сезоне", orange: true },
            ].map((s) => (
