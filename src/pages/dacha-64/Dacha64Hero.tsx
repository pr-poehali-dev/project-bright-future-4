...
const images = [
  {
    src: "https://cdn.poehali.dev/projects/614242ea-a957-4915-8b40-2cdf0c2c40f1/bucket/24b669fb-4ed8-41fe-88ae-83302e8894b9.png",
    alt: "Дача «Светлая» 64 м² — вид спереди с террасой",
  },
]

const specs = [
  { label: "Габариты", value: "8,0 × 8,0 м" },
  { label: "Общая площадь", value: "64 м²" },
  { label: "Этажей", value: "1" },
  { label: "Фундамент", value: "Винтовые сваи" },
  { label: "Фасад", value: "Белый сайдинг" },
  { label: "Терраса", value: "Крытая" },
  { label: "Кровля", value: "Металлочерепица" },
  { label: "Год постройки", value: "2026" },
]

export default function Dacha64Hero() {
    ...
    <>
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="container mx-auto px-6 md:px-12 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span>/</span>
          <span className="text-[#1a0f0f] font-medium">Дача «Светлая» 64 м²</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight mb-4 leading-tight">
                Дача «Светлая»<br />
                <span className="text-orange-500">8,0 × 8,0 м</span>
              </h1>
              <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6">
                Одноэтажная каркасная дача <strong>64 м²</strong> на винтовых сваях — светлый белый фасад,
                крытая терраса с балюстрадой и уютный интерьер. Построена быстро, в срок, без доплат.
                Тёплая, качественная, с гарантией. Строим под ключ по всей Тульской области.
              </p>
