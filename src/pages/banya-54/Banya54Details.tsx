...
const whyList = [
  ...
  "Имитация бруса — баня выглядит как настоящий деревенский шедевр",
...
const included = [
  ...
  "Мягкая кровля",
  "Фасадная отделка — имитация бруса + белые наличники",
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100">
            {[
              ...
              { value: "40–60 дней", label: "Срок постройки", sub: "Каркасная технология — первый пар уже этим летом", orange: true },
            ].map((s) => (
